 ...
 */
@WebServlet("/admin/incomplete/location")
public class GetIncompleteFormByLocationServlet extends BaseServlet {
    private final AdminServiceImpl adminService = ServiceFactory.getAdminService();
    private static final Logger logger = LoggerFactory.getLogger(GetIncompleteFormByLocationServlet.class);

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        JSONObject requestBody = (JSONObject) request.getAttribute("requestBody");

        Result result = adminService.getIncompleteFormByLocation(requestBody.getString("location"),
