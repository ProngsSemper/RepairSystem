 ...
 */
@WebServlet("/admin/incomplete/stuName")
public class GetIncompleteByStudentNameServlet extends BaseServlet {
    private final AdminServiceImpl adminService = ServiceFactory.getAdminService();
    private static final Logger logger = LoggerFactory.getLogger(GetIncompleteByStudentNameServlet.class);

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        JSONObject requestBody = (JSONObject) request.getAttribute("requestBody");
        Result result = adminService.getAllIncompleteFormByStudentName(requestBody.getString("stuName"),
