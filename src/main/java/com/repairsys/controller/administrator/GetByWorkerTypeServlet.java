 ...
 */
@WebServlet("/admin/type/form")
public class GetByWorkerTypeServlet extends BaseServlet {
    private final AdminServiceImpl adminService = ServiceFactory.getAdminService();
    private static final Logger logger = LoggerFactory.getLogger(GetByWorkerTypeServlet.class);

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        JSONObject requestBody = (JSONObject) request.getAttribute("requestBody");

        Result result = adminService.queryByWorkerTypeForm(requestBody.getString("wType"),
