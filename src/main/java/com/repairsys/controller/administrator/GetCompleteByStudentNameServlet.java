 ...
 */
@WebServlet("/admin/complete/stuName")
public class GetCompleteByStudentNameServlet extends BaseServlet {
    private final AdminServiceImpl adminService = ServiceFactory.getAdminService();
    private static final Logger logger = LoggerFactory.getLogger(GetCompleteByStudentNameServlet.class);

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        JSONObject requestBody = (JSONObject) request.getAttribute("requestBody");
        Result result = adminService.getAllCompleteFormByStudentName(requestBody.getString("stuName"),
