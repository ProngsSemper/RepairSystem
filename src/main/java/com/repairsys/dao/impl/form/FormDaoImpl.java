...
public class FormDaoImpl extends AbstractPageDao<Form> implements FormDao {
    ...
    public List<Form> adminQueryIncompleteFormByFormId(String formId) {
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), ADMIN_QUERY_INCOMPLETE_BY_FORMID, formId);
    }
    ...
    public List<Form> workerQueryIncompleteFormByFormId(String formId, int wKey) {
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), WORKER_QUERY_INCOMPLETE_BY_FORMID, formId, wKey);
    }

    @Override
    public List<Form> workerQueryCompleteFormByFormId(String formId, int wKey) {
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), WORKER_QUERY_COMPLETE_BY_FORMID, formId, wKey);
    }

    @Override
    public List<Form> adminQueryCompleteFormByFormId(String formId) {
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), ADMIN_QUERY_COMPLETE_BY_FORMID, formId);
    }

    @Override
    public List<Form> workerQueryOldByFormId(String formId, int wKey) {
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), WORKER_QUERY_BY_FORMID_OLD, formId, wKey);
    }

    @Override
    public List<Form> adminQueryOldByFormId(String formId) {
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), ADMIN_QUERY_BY_FORMID_OLD, formId);
    }
    ...
    public List<Form> queryByStudentId(String stuId) {
        ...
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), finalSql);
    }
    ...
    public List<Form> queryFormListByStatus(byte status) {
        ...
        return super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), sql, status);
    }
    ...
    public Boolean apply(Object... args) {
        ...
        Connection conn = com.repairsys.util.db.JdbcUtil.getConnection();
    ...
    public Form getNewFormId(String stuId) {
        ...
        return super.selectOne(com.repairsys.util.db.JdbcUtil.getConnection(), sql, stuId);
    }
    ...
    public Boolean apply(String stuId, int code, String formMsg, Date formDate, String stuMail, String photoId) {
        ...
        return super.addOne(com.repairsys.util.db.JdbcUtil.getConnection(), APPLY_FORM_DEFAULT, stuId, code, formMsg, formDate, stuMail, photoId);
    }
    ...
    public Boolean deleteBefore(String tableName, Date date) {
        ...
        boolean b = super.deleteOne(com.repairsys.util.db.JdbcUtil.getConnection(), patchDelete);
        return b;
    }
    ...
    public Boolean moveTo() {
        boolean b = super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), QUERY_MORE_THAN_DAY7);

        if(b)
        {
            super.deleteOne(com.repairsys.util.db.JdbcUtil.getConnection(), DELETE_FORM_DAY_OVER7);
        }

        b = super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), QUERY_MORE_THAN_DAY14);
        if(b)
        {
            return super.deleteOne(com.repairsys.util.db.JdbcUtil.getConnection(), DELETE_FORM_DAY_OVER14);
        }
        return false;
    ...
    public Boolean setAdminKey(String adminKey, String formId) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), SET_ADMIN_KEY, adminKey, formId);
    }
    ...
    public Boolean setwKey(String workerKey, String formId) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), SET_WORKER_KEY, workerKey, formId);
    }
    ...
    public Boolean setPhotoId(String id, String formId) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), SET_PHOTO_KEY, id, formId);
    }
    ...
    public Boolean setEndDate(Date date, String formId) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), SET_FINISH_DAY, date, formId);
    }
    ...
    public Boolean setQueryCode(int code, String formId) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), SET_FINISHED_WORK, code, formId);
    }
    ...
    public Boolean updateForm(String formId, Date endDate, int queryCode, int adminKey, int wKey) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), UPDATE_INFORMATION, endDate, queryCode, adminKey, wKey, formId);
    }
    ...
    public List<Form> getListByWorkerId(String workerKey) {
        List<Form> list1 = super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), QUERY_FORM_BY_WKEY, workerKey);
        List<Form> list2 = super.selectList(com.repairsys.util.db.JdbcUtil.getConnection(), QUERY_OLDFORM_BY_WKEY, workerKey);
        list1.addAll(list2);
        return list1;
    }
    ...
    public int getTotalCount() {
        ...
        return super.getCount(com.repairsys.util.db.JdbcUtil.getConnection(), sql);
    }
    ...
    public int getTotalCount(int queryCode) {
        return super.getCount(com.repairsys.util.db.JdbcUtil.getConnection(), QUERY_FORM_CODE, queryCode);
    }
    ...
    public Boolean apply(String stuId, int code, String formMsg, Date formDate, String formMail, String photoId, String room) {
        ...
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), INSERT_FORM, stuId, code, formMsg, formDate, formMail, photoId, room);
    }

    @Override
    public Boolean boostLevel(int formId) {
        super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), RESET_QUERYCODE, formId);
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), BOOST_LEVEL, formId);
    }

    @Override
    public Boolean studentConfirm(int formId) {
        if (super.selectOne(com.repairsys.util.db.JdbcUtil.getConnection(), QUERY_BY_FORMID, formId) == null) {
            return false;
        }
        super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), SET_FINISH_DAY, new Date(System.currentTimeMillis()), formId);
        super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), STUDENT_CONFIRM, formId);
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), DELETE_STUDENT_CONFIRM, formId);
    }

    @Override
    public Boolean delete(int formId) {
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), DELETE_ONE, formId);
    }
    ...
    public Boolean arrange(int wKey, int adminKey, String appointDate, int appointment, int formId) {
        ...
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), ARRANGE, wKey, adminKey, appointDate
                , appointment, formId);
    }
    ...
    public Boolean evaluate(String evaluation, int wKey, int formId) {
        if ("good".equals(evaluation)) {
            super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), FINISH_EVALUATE, formId);
            return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), GOOD, wKey);
        } else if ("mid".equals(evaluation)) {
            super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), FINISH_EVALUATE, formId);
            return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), MID, wKey);
        } else if ("bad".equals(evaluation)) {
            super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), FINISH_EVALUATE, formId);
            return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), BAD, wKey);
        } else {
            return false;
        }
    }
    ...
    public Boolean appointAgain(String appointDate, int appointment, int formId) {
        ...
        return super.updateOne(com.repairsys.util.db.JdbcUtil.getConnection(), APPOINT_AGAIN, appointDate, appointment, formId);
    }
}
