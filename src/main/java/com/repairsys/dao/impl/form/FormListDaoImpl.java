...
public final class FormListDaoImpl extends FormDaoImpl implements PageDao<List<Form>> {
    ...
    public int getPageCountByStudentId(String studentId) {
        return super.getCount(JdbcUtil.getConnection(), GET_STU_ID_COUNT, studentId);
    ...
    private static final String STUDENT_GET_INCOMPLETE_BY_STUDENT_ID = "select * from form where stuId =? ORDER BY formId DESC limit ?,?";
    private static final String STUDENT_GET_COMPLETE_BY_STUDENT_ID = "select * from oldform where stuId =? ORDER BY formId DESC limit ?,?";

    public List<Form> getIncompleteListByStudentId(String studentId, int page, int limit) {
        int[] ans = EasyTool.getLimitNumber(page, limit);
        return super.selectList(JdbcUtil.getConnection(), STUDENT_GET_INCOMPLETE_BY_STUDENT_ID, studentId, ans[0], ans[1]);
    }

    public List<Form> getCompleteListByStudentId(String studentId, int page, int limit) {
        int[] ans = EasyTool.getLimitNumber(page, limit);
        return super.selectList(JdbcUtil.getConnection(), STUDENT_GET_COMPLETE_BY_STUDENT_ID, studentId, ans[0], ans[1]);
    }
    ...
    public List<Form> workerGetAllIncompleteListByStudentName(String studentName, int wKey, int page, int limit) {
        ...
        int[] ans = EasyTool.getLimitNumber(page, limit);
        return super.selectList(JdbcUtil.getConnection(), getAllByStudentName, wKey, ans[0], ans[1]);
    }
    ...
    public List<Form> adminGetCompleteListByLocation(String location, int page, int limit) {
        String getAllByLocation = "select * from form where room like '%" + location + "%' and queryCode<>0 UNION select * from oldform where room like '%" + location + "%' and queryCode<>0 limit ?,?";
        int[] ans = EasyTool.getLimitNumber(page, limit);
        return super.selectList(JdbcUtil.getConnection(), getAllByLocation, ans[0], ans[1]);
    }
    ...
    public List<Form> workerGetAllCompleteListByStudentName(String studentName, int wKey, int page, int limit) {
        ...
        int[] ans = EasyTool.getLimitNumber(page, limit);
        return super.selectList(JdbcUtil.getConnection(), getAllByStudentName, wKey, wKey, ans[0], ans[1]);
    }
    ...
    public int getAllWorkerIncompleteCountByStudentName(String studentName, int wKey) {
        ...
        return super.getCount(JdbcUtil.getConnection(), sql, wKey);
    }
    ...
    public int getAllWorkerCompleteCountByStudentName(String studentName, int wKey) {
        ...
        return super.getCount(JdbcUtil.getConnection(), COUNT_SQL.replaceAll("where", rex), wKey, wKey);
    }
    ...
    public int getAllCountByStudentId(String studentId) {
        ...
        return super.getCount(JdbcUtil.getConnection(), COUNT_SQL.replaceAll("where", rex), studentId);
    ...
    public int getAdminKeyById(String adminId) {
        return super.selectOne(JdbcUtil.getConnection(), GET_BY_ADMIN_KEY, adminId).getAdminKey();
    }

    private static final String GET_BY_WID = "select wKey from workers where wId = ?";

    public int getWorkerKeyById(String wId) {
        return super.selectOne(JdbcUtil.getConnection(), GET_BY_WID, wId).getwKey();
    }
    ...
    public List<Form> adminCompleteForm(int page, int size) {
        int[] ans = EasyTool.getLimitNumber(page, size);
        return super.selectList(JdbcUtil.getConnection(), ADMIN_COMPLETE_FORM, ans[0], ans[1]);
    }
    ...
    public List<Form> workerCompleteForm(String wId, int page, int size) {
        int wKey = getWorkerKeyById(wId);
        int[] ans = EasyTool.getLimitNumber(page, size);
        return super.selectList(JdbcUtil.getConnection(), WORKER_COMPLETE_FORM, wKey, wKey, ans[0], ans[1]);
    }
    ...
    public List<Form> studentUndoneForm(String stuId, int page, int size) {
        int[] ans = EasyTool.getLimitNumber(page, size);
        return super.selectList(JdbcUtil.getConnection(), STUDENT_UNDONE, stuId, ans[0], ans[1]);
    }
