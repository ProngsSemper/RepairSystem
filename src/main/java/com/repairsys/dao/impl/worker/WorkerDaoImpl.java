...
public class WorkerDaoImpl extends BaseDao<Worker> implements com.repairsys.dao.WorkerDao {
    ...
    public Worker login(String wId, String wPassword) {
        ...
        super.updateOne(JdbcUtil.getConnection(), TOKEN, wToken, wId);
    ...
    public Worker getWorkerKeyById(String workerId) {
        return super.selectOne(JdbcUtil.getConnection(), GET_WORKER_KEY_BY_ID, workerId);
    }

    public Worker getWorkerNameById(String workerId) {
        return super.selectOne(JdbcUtil.getConnection(), GET_WORKER_NAME_BY_ID, workerId);
    }
    ...
    public int getAllIncompleteCountBywKey(int wKey) {
        return super.getCount(JdbcUtil.getConnection(), CNT_SQL, wKey);
    ...
    public int getAllCompleteCountBywKey(int wKey) {
        ...
        return super.getCount(JdbcUtil.getConnection(), cntSql.replaceAll("where", rex), wKey, wKey);
    ...
    public String getEvaluation(int wKey) {
        Worker worker = super.selectOne(JdbcUtil.getConnection(), SELECT_WORKER, wKey);
